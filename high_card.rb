...
def determine_winner
  ...
  winnerCard = winnerCard.join(" of ") #I can't seem to figure this part out. I want to just return the rank and the suit, and return the index for score. Example, 7 of hearts instead of 7 of hearts of 6. I don't want the 6 there.
  ...
  #I want the index to print out for the score here
